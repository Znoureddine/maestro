    ...
    `
      ...
      <section dir="rtl" className="bg-[#fff8ec] text-center py-12 px-4">
        ...
        <div dir="ltr" className="flex justify-center mt-8 w-full overflow-hidden px-4 sm:px-8">
          ...
          className="w-full max-w-full scale-60 sm:scale-100"
          labelStyle={{
            color: '#664430',
      ...
      <section dir="rtl" className="bg-[#f7efe7] py-12 px-6">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-center gap-10">
          ...
          <div className="text-brown font-kufam text-[#4b2e2e] text-lg md:text-xl font-medium text-right space-y-4 leading-loose max-w-2xl">
            <p>
              يمكن تكوني وهنا لأِنك سئمتي من نفس القصة:
              تتنازلي كل مرة، تسكتي عن حدودك، تكملي وجعك...
              حتى تخاطري على حب، أو زواج، أو علاقة؛
            ...
            <p>
              تصبحي واعية بجذورك النفسية من الطفولة.
              تعرفي كيف ترسمي حدودك بقوة وودّ.
              تخاطري على حبك لنفسك قبل أي شخص.
              وتعيشي علاقة صحية تستحقيها فعلاً مليانة
              راحة، أمان ورفقة.
            </p>
          </div>
